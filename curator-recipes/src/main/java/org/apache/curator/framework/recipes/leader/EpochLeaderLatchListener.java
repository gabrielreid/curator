...
/**
 * Extension of the {@link LeaderLatchListener} interface that provides
 * a monotonically incrementing epoch value with each call to {@link #isLeader}.
 */
public interface EpochLeaderLatchListener
{
  /**
   ...
   * this occurs, you can expect {@link #isLeader(int)} to also be called
  */
